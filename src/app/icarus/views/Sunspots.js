...
export class Sunspots extends React.Component {
  ...
  renderImage() {
    ...
    return <image width={width} height={height} xlinkHref={image.image} />
  }
  ...
  renderSunspot(sunspot) {
    ...
    return (
      <g
        className="Graph__sunspotInfo"
        transform={transform}
        key={sunspot.location}
      >
        <circle className="Graph__sunspot" cx="0" cy="0" r="10" />
        <text className="Graph__sunspotText">
          <tspan className="Graph__sunspotInfoLabel" x="0" y="0">
            Spot class:{' '}
          </tspan>
          <tspan className="Graph__sunspotInfoValue" x="132" y="0">
            {sunspot.spotclass}
          </tspan>
          <tspan className="Graph__sunspotInfoLabel" x="0" y="20">
            Magnetic class:{' '}
          </tspan>
          <tspan className="Graph__sunspotInfoValue" x="132" y="20">
            {sunspot.magneticclass}
          </tspan>
          <tspan className="Graph__sunspotInfoLabel" x="0" y="40">
            Location:{' '}
          </tspan>
          <tspan className="Graph__sunspotInfoValue" x="132" y="40">
            {sunspot.location}
          </tspan>
          <tspan className="Graph__sunspotInfoLabel" x="0" y="60">
            Size:{' '}
          </tspan>
          <tspan className="Graph__sunspotInfoValue" x="132" y="60">
            {sunspot.size}
          </tspan>
          <tspan className="Graph__sunspotInfoLabel" x="0" y="80">
            No. of sunspots:{' '}
          </tspan>
          <tspan className="Graph__sunspotInfoValue" x="132" y="80">
            ...
            <div className="ScrolledContent">
              ...
              <div className="Text__body">
                <p>
                  ...
                  that appear visibly as dark spots compared to surrounding
                  regions. They correspond to concentrations of magnetic field
                  flux that inhibit convection and result in reduced surface
                  temperature compared to the surrounding photosphere. Sunspots
                  usually appear in pairs, with pair members of opposite
                  magnetic polarity. The number of sunspots varies according to
                  the approximately 11-year solar cycle.
                </p>
                <p>
                  Individual sunspots may endure anywhere from a few days to a
                  few months, but eventually decay. Sunspots expand and contract
                  as they move across the surface of the Sun with a size ranging
                  from 16 kilometers to 160,000 kilometers in diameter. The
                  larger variety are visible from Earth without the aid of a
                  telescope. They may travel at relative speeds ("proper
                  motions") of a few hundred meters per second when they first
                  emerge.
                </p>
                <p>
                  Reflecting intense magnetic activity, sunspots accompany
                  secondary phenomena such as coronal loops (prominences) and
                  reconnection events. Most solar flares and coronal mass
                  ejections originate in magnetically active regions around
                  visible sunspot groupings. Similar phenomena indirectly
                  observed on stars other than the sun are commonly called
