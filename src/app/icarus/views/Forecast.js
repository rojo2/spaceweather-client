...
export class Forecast extends React.Component {
  ...
  componentWillMount() {
    if (!this.props.location.query.filter || !this.props.location.query.flux) {
  ...
  renderRightPanel() {
    const fn =
      this.props.location.query.show === 'alerts'
        ? this.renderAlerts
        : this.renderForecast
    return (
  ...
  render() {
    ...
    console.log(firstGeomagActivity, secondGeomagActivity, thirdGeomagActivity)

    const firstGeo = firstGeomagActivity.value / 5.0
    const firstTransformGeomagActivity = { transform: `scaleY(${firstGeo})` }
    const firstTransformSolarRadiation = {
      transform: `scaleY(${firstSolarRadiation.value * 0.01})`,
    }
    const firstTransformBlackout = {
      transform: `scaleY(${firstRadioBlackout.value * 0.01})`,
    }

    const secondGeo = secondGeomagActivity.value / 5.0
    const secondTransformGeomagActivity = { transform: `scaleY(${secondGeo})` }
    const secondTransformSolarRadiation = {
      transform: `scaleY(${secondSolarRadiation.value * 0.01})`,
    }
    const secondTransformBlackout = {
      transform: `scaleY(${secondRadioBlackout.value * 0.01})`,
    }

    const thirdGeo = thirdGeomagActivity.value / 5.0
    const thirdTransformGeomagActivity = { transform: `scaleY(${thirdGeo})` }
    const thirdTransformSolarRadiation = {
      transform: `scaleY(${thirdSolarRadiation.value * 0.01})`,
    }
    const thirdTransformBlackout = {
      transform: `scaleY(${thirdRadioBlackout.value * 0.01})`,
    }
          ...
          <div className="Panel__content">
            <div className="Forecast__days">
              <div className="Forecast__day">
                <div className="Forecast__dayLabel">
                  {this.getMonthAbbr(firstRadioBlackout.ts.getMonth())}{' '}
                ...
                <div className="Forecast__dayData">
                  ...
                  <div className="Forecast__stats">
                    <div className="Forecast__statsLabel--solar">
                  ...
                  <div className="Forecast__stats">
                    <div className="Forecast__statsLabel--blackout">
                      Radio Blackout Activity
                    </div>
                    <div className="Forecast__statsValue--blackout">
              ...
              <div className="Forecast__day">
                <div className="Forecast__dayLabel">
                  {this.getMonthAbbr(secondRadioBlackout.ts.getMonth())}{' '}
              ...
              <div className="Forecast__day">
                <div className="Forecast__dayLabel">
                  {this.getMonthAbbr(thirdRadioBlackout.ts.getMonth())}{' '}
        ...
        <div className="Forecast__alerts">
          <div className="Panel__header">
            ...
            <div className="Panel__menu">
              <Link
                to={{ pathname: '/forecast', query: { show: 'forecast' } }}
              ...
              <Link
                to={{ pathname: '/forecast', query: { show: 'alerts' } }}
                activeClassName="isActive"
                className="Panel__menuItem"
              >
                Alerts
