          ...
          <div className="Panel__content--text">
            <div className="ScrolledContent">
              ...
              <div className="Text__body">
                ...
                <h3>Recent cycles</h3>
                <h4>Cycle 25</h4>
                <p>There are many, often mutually contradictory predictions, based on different methods, for the solar cycle 25, ranging from very weak to moderate magnitude. At present, no definite prediction can be made.</p>
                <h4>Cycle 24</h4>
