          ...
          <div className="Panel__content--text">
            <div className="ScrolledContent">
              ...
              <div className="Text__body">
                ...
                <h3>Recent cycles</h3>
            <h4>Cycle 25</h4>
	    <p>An international panel of experts coordinated by the NOAA and NASA, to which the WDC-SILSO contributed, released a preliminary forecast for Solar Cycle 25 on April 5, 2019. Based on a compilation of more than 60 forecasts published by various teams using a wide range of methods, the panel reached a consensus indicating that cycle 25 will most likely peak between 2023 and 2026 at a maximum sunspot number between 95 and 130.</p>
	   <p>Therefore, solar cycle 25 will be similar to cycle 24, which peaked at 116 in April 2014.</p>
                <h4>Cycle 24</h4>
                ...
                <p>Sources: Source: WDC-SILSO, Royal Observatory of Belgium, Brussels <a href="http://sidc.be/silso/home" target="_blank">http://sidc.be/silso/home</a> and <a href="https://en.wikipedia.org/wiki/Solar_cycle" target="_blank">Wikipedia</a></p>
              </div>
            </div>
          </div>
        </div>
