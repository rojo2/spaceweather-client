...
import Background from "icarus/views/Background";
import Sound from "icarus/sound/Sound";
        ...
        <div className="Page">
          ...
          <div className="Page__bottom">
            <div className="AboutIcarus">
              <input type="checkbox" id="about-trigger" className="AboutIcarus__input" />
              <label htmlFor="about-trigger" className="AboutIcarus__button">
                <div className="AboutIcarus__buttonText">About Icarus Project</div>
                <div className="AboutIcarus__buttonClose">
                  <svg width="32" height="32" viewBox="0 0 30 30" className="AboutIcarus__closeIcon">
              ...
              <div className="AboutIcarus__content">
                <div className="AboutIcarus__infoPanel">
                  ...
                  <p>Also, please find all the source code available at github: backend and frontend.</p>
            ...
            <div className="Controls">
              <a href="" className={audioClasses} onClick={this.handleAudioClick}>
                <div className="Button__label">Audio {audioState}</div>
                <svg viewBox="0 0 22 16" x="0" y="0" width="22" height="16" className="Icon--sound">
                  <rect x="0" y="0" width="1" height="16" className="Sound Sound--1"></rect>
                  <rect x="3" y="0" width="1" height="16" className="Sound Sound--2"></rect>
                  <rect x="6" y="0" width="1" height="16" className="Sound Sound--3"></rect>
                  <rect x="9" y="0" width="1" height="16" className="Sound Sound--1"></rect>
                  <rect x="12" y="0" width="1" height="16" className="Sound Sound--4"></rect>
                  <rect x="15" y="0" width="1" height="16" className="Sound Sound--2"></rect>
                  <rect x="18" y="0" width="1" height="16" className="Sound Sound--1"></rect>
                  <rect x="21" y="0" width="1" height="16" className="Sound Sound--3"></rect>
                </svg>
              </a>
            </div>
          </div>
