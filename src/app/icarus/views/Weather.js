...
export class Weather extends React.Component {
  ...
  loadFlux(flux) {
    ...
    switch (flux) {
    default:
      console.warn('default flux', flux)
      break
    case 'solar-wind':
      this.loadSolarWind().then(
        this.handleFluxComplete,
        this.handleFluxComplete
      )
      break
    case 'particle':
      this.loadProtonFlux().then(
        this.handleFluxComplete,
        this.handleFluxComplete
      )
      break
    case 'electron':
      this.loadElectronFlux().then(
        this.handleFluxComplete,
        this.handleFluxComplete
      )
      break
    case 'x-ray':
      this.loadXrayFlux().then(
        this.handleFluxComplete,
        this.handleFluxComplete
      )
      break
  ...
  getFluxData(flux) {
    ...
    default:
    case 'solar-wind':
      return this.state.solarWind
    case 'particle':
      return this.state.protonFlux
    case 'electron':
      return this.state.electronFlux
    case 'x-ray':
      return this.state.xrayFlux
    }
  }
        ...
        <div className="Weather__EITFilters">
          <div className="Panel__header">
            ...
            <div className="Panel__menu">
              <Link
                to={{ pathname: '/weather', query: { filter: 1, flux: flux } }}
              ...
              <Link
                to={{ pathname: '/weather', query: { filter: 2, flux: flux } }}
                activeClassName="isActive"
                className="Panel__menuItem"
              >
              ...
              <Link
                to={{ pathname: '/weather', query: { filter: 3, flux: flux } }}
                activeClassName="isActive"
                className="Panel__menuItem"
              >
              ...
              <Link
                to={{ pathname: '/weather', query: { filter: 4, flux: flux } }}
                activeClassName="isActive"
                className="Panel__menuItem"
              >
              ...
              <Link
                to={{ pathname: '/weather', query: { filter: 5, flux: flux } }}
                activeClassName="isActive"
                className="Panel__menuItem"
              >
          ...
          <div className="Panel__header">
            ...
            <div className="Panel__menu">
              <Link
                to={{
                  pathname: '/weather',
                  query: { filter: filter, flux: 'solar-wind' },
                }}
                activeClassName="isActive"
                className="Panel__menuItem"
              >
              ...
              <Link
                to={{
                  pathname: '/weather',
                  query: { filter: filter, flux: 'particle' },
                }}
                activeClassName="isActive"
                className="Panel__menuItem"
              >
              ...
              <Link
                to={{
                  pathname: '/weather',
                  query: { filter: filter, flux: 'electron' },
                }}
                activeClassName="isActive"
                className="Panel__menuItem"
              >
              ...
              <Link
                to={{
                  pathname: '/weather',
                  query: { filter: filter, flux: 'x-ray' },
                }}
                activeClassName="isActive"
                className="Panel__menuItem"
              >
